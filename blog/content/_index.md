...
description: "The Generals project: an interactive report on building a reinforcement-learning agent for generals.io, with the trained bot playable in the page."
date: 2026-07-18
draft: false
...
This is the current champion of the project — a 2.8M-parameter recurrent policy trained end-to-end in JAX, exported to ONNX, running entirely in your browser. You are blue; the crown is your general. Take the red one before it takes yours.

{{< generals-game mode="human" >}}

Everything below is the story of how this bot came to be: the simulator, the network, the training machinery, and the experiments — including the failed ones. Deeper dives into individual experiments live in the [field notes](#field-notes) at the end of this report.
...
<figure class="figure-breakout">
  <img src="posts/learning-to-see-through-fog/game-loop.svg" alt="The reinforcement learning loop from game state to observation, policy, reward, and next state.">
...
<figure class="figure-breakout">
  <img src="posts/learning-to-see-through-fog/network.svg" alt="An 18-plane observation passes through a CNN, spatial projection, LSTM, actor, and critic.">
...
<figure class="figure-breakout">
  <img src="posts/learning-to-see-through-fog/ppo.svg" alt="A terminal win propagates advantage backward through actions, followed by a graph of PPO clipping probability ratios.">
...
<figure class="figure-breakout">
  <img src="posts/learning-to-see-through-fog/jax.svg" alt="One pure turn function transformed by vmap, scan, grad, and jit into a fused GPU training program.">
...
<figure class="figure-breakout">
  <img src="posts/learning-to-see-through-fog/performance.svg" alt="The slow JAX to NumPy to Torch path and benchmark bars for hybrid, Torch-native, and pure JAX training.">
...
<figure class="figure-breakout">
  <img src="posts/learning-to-see-through-fog/league.svg" alt="A main agent surrounded by curriculum opponents, historical checkpoints, exploiters, and evaluation-driven matchmaking.">
...
<figure class="figure-breakout">
  <img src="posts/learning-to-see-through-fog/progress.svg" alt="Historical agent score progress followed by the failed recurrent league agent's low per-opponent win rates.">
